package com.pds.chambitas.ui.serviciossolicitados.historial_util
...
class AdapterHistorial(ctx: Context): BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup?): View {
        ...
        val prestador = lista[position].prestador_name
        ...
        holder.prestadorName = myView.findViewById(R.id.textView45)
        holder.prestadorName!!.text = prestador
...
internal class ListaViewHolder() {
    ...
    var prestadorName: TextView? = null
}